...
```
claude "run gtm-onboarding-journey on ./calls/acme-onboarding.txt"
```
...
```
claude "run gtm-onboarding-journey on ./exports/new-customers.csv"
```
