...
```
claude "run gtm-pilot-to-conversion on ./calls/acme-pilot-checkin.txt"
```
...
```
claude "run gtm-pilot-to-conversion on ./exports/pipeline.csv"
```
